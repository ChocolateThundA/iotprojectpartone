...
let timesHelloed = 0;
//increment times helloed
// function helloAgain()
// {
//   timesHelloed = timesHelloed + 1;
// }
//return times helloed with formatting
// function countHelloes()
// {
//   return 'timesHelloed=${timesHelloed}';
// }
...
//user says hello?
app.get('/hello',helloAgain(),(req, res) => {
  res
    .status(200)
    //.helloAgain()
...
app.get('/timesHelloed',countHelloes(),(req,res) =>{
  res
    .status(200)
    .countHelloes()
